      ...
      <div class="col-lg-12">
        <div class="w-100 text-center py-4 img-profile-user">
          ...
          @endif
            ...
            {{-- Phone number --}}
            @if (auth()->guest() && $user->phone_number || auth()->check() && auth()->id() != $user->id && $user->phone_number)
            <a href="tel:{{ $user->phone_number }}" title="{{trans('general.call')}}" class="btn btn-google btn-profile mr-1">
                <i class="feather icon-phone mr-1 mr-lg-0"></i> <span class="d-lg-none">{{trans('general.call')}}</span>
            </a>
            @endif
