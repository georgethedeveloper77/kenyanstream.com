...
<section class="section section-sm">
    ...
    <div class="input-group mb-4">
        ...
        <input class="form-control" name="phone_number" placeholder="{{ trans('general.phone_number') }}" 
               value="{{ auth()->user()->phone_number }}" type="tel" pattern="[0-9]{12}" required>
    </div>
</div>
            ...
            <div class="col-md-6">
                <div class="input-group mb-4">
                  ...
                  <input class="form-control" name="profession" placeholder="{{trans('users.profession_ocupation')}}" 
              ...
              <div class="col-md-6">
                ...
                <select name="language" class="form-control custom-select">
                  <option @if (auth()->user()->language == '') selected="selected" @endif value="">({{trans('general.language')}}) 
					  {{ __('general.not_specified') }}</option>
                  @foreach (Languages::orderBy('name')->get() as $languages)
                    <option @if (auth()->user()->language == $languages->abbreviation) selected="selected" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    phoneInput.addEventListener('input', function() {
        ...
        } else if (value.startsWith('01') && value.length === 9) {
            value = '254' + value.substring(1);
        }
