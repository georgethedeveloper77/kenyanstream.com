    ...
    <div class="container">
      ...
      @if( $settings->payout_method_paypal == 'on' )
                      <div class="custom-control custom-radio mb-3">
                          <input name="payment_gateway" value="PayPal" id="radio1" class="custom-control-input" @if (auth()->user()->payment_gateway == 'PayPal') checked @endif type="radio">
                          <label class="custom-control-label" for="radio1">
                              <span><img src="{{url('public/img/payments', auth()->user()->dark_mode == 'off' ? 'Mpesa.png' : 'Mpesa.png')}}" width="80"/></span>
                              <small class="w-100 d-block">* {{trans('general.processor_no_fees_may_apply')}}</small>
                          </label>
                      </div>
                      ...
                      <form method="POST" action="{{ url('settings/payout/method/paypal') }}" id="PayPal" @if (auth()->user()->payment_gateway != 'PayPal') class="display-none" @endif>
                          ...
                          <div class="form-group">
                              <div class="input-group mb-4">
                                  ...
                                  <input class="form-control" name="email_paypal" value="{{auth()->user()->paypal_account == '' ? old('email_paypal') : auth()->user()->paypal_account}}" placeholder="{{trans('general.mpesa_phone')}}" required type="number">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <div class="input-group mb-4">
                                  ...
                                  <input class="form-control" name="email_paypal_confirmation" placeholder="{{trans('general.confirm_mpesa_phone')}}" required type="number">
                              </div>
                          </div>
