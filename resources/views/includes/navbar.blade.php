					 ...
					 {{--Guest--}}
                        @guest
                            ...
                            @if ($settings->live_streaming_status == 'on')
                                <a class="nav-link  @if(request()->is('explore/creators/live'))active-category @endif"
                            ...
                            <li class="nav-item">
                                <a class="nav-link"
                                  href="{{url('creators/new')}}">{{trans('general.new_creators')}}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{url('blog')}}">{{trans('general.blog')}}</a>
                            </li>
