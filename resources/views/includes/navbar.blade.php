		...
		<div class="container-fluid d-flex position-relative">
			...
			@if (auth()->guest() && $settings->who_can_see_content == 'all' || auth()->check())
				...
				@endif
					...
					@guest
						<li class="nav-item">
							<a class="nav-link" href="{{url('creators')}}">{{__('general.view_all_creators')}}</a>
						</li>
					<li class="nav-item">
						<a class="nav-link" href="{{url('creators/more-active')}}">{{__('general.more_active')}}</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{url('creators/new')}}">{{__('general.new_creators')}}</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="{{url('explore/creators/live')}}">{{__('general.live')}}</a>
					</li>
