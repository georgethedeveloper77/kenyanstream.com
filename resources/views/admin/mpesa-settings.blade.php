                    ...
                    <div class="card-body p-lg-5">
                        ...
                        <form method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->mpesa_shortcode }}" name="mpesa_shortcode" type="number" class="form-control">
                                    <small class="d-block"><a href="https://developer.safaricom.co.ke/" target="_blank">https://developer.safaricom.co.ke</a></small>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label text-lg-end">Till Number</label>
                                <div class="col-sm-10">
                                    <input value="{{ $data->mpesa_till_number }}" name="mpesa_till_number" type="number" class="form-control">
                                    <small class="d-block"><a href="https://developer.safaricom.co.ke/" target="_blank">https://developer.safaricom.co.ke</a></small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->mpesa_consumer_key }}" name="mpesa_consumer_key" type="password" class="form-control">
                                    <small class="d-block"><a href="https://developer.safaricom.co.ke/" target="_blank">https://developer.safaricom.co.ke</a></small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->mpesa_consumer_secret }}" name="mpesa_consumer_secret" type="password" class="form-control">
                                    <small class="d-block"><a href="https://developer.safaricom.co.ke/" target="_blank">https://developer.safaricom.co.ke</a></small>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->mpesa_passkey }}" name="mpesa_passkey" type="password" class="form-control">
                                    <small class="d-block"><a href="https://developer.safaricom.co.ke/" target="_blank">https://developer.safaricom.co.ke</a></small>
                                </div>
                            </div>
