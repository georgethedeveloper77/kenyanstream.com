...
class AdminController extends Controller
{
	...
	public function savePaymentsGateways($id, Request $request)
	{
		...
		// Set Mpesa Keys on .env file
        if ($data->name == 'Mpesa') {
            Helper::envUpdate('MPESA_SHORTCODE', $input['mpesa_shortcode']);
            Helper::envUpdate('MPESA_TILL_NUMBER', $input['mpesa_till_number']);
            Helper::envUpdate('MPESA_CONSUMER_KEY', $input['mpesa_consumer_key']);
            Helper::envUpdate('MPESA_CONSUMER_SECRET', $input['mpesa_consumer_secret']);
            Helper::envUpdate('MPESA_PASSKEY', $input['mpesa_passkey']);
        }
